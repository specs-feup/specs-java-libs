...
class MatFileInputStream {
    ...
    /**
     * Reads data (number of bytes red is determined by <i>data type</i>) from the stream to <code>int</code>.
     * 
     * @return
     * @throws IOException
     */
    ...
    /**
     * Reads data (number of bytes red is determined by <i>data type</i>) from the stream to <code>char</code>.
     * 
     * @return - char
     * @throws IOException
     */
    ...
    /**
     * A type, according to MatDataTypes.mi* .
     * 
     * @return
     */
    public int getType() {
    ...
    /**
     * Reads data (number of bytes red is determined by <i>data type</i>) from the stream to <code>double</code>.
     * 
     * @return - double
     * @throws IOException
     */
    ...
    /**
     * Reads the data into a <code>{@link ByteBuffer}</code>. This method is only supported for arrays with backing
     * ByteBuffer (<code>{@link ByteStorageSupport}</code>).
     * 
     * @param dest
     ...
     * @param storage
     *            the backing <code>{@link ByteStorageSupport}</code> that gives information how data should be
     *            interpreted
