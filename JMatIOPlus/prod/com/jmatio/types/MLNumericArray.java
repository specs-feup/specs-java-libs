	...
	ByteStorageSupport<T>
{
    ...
    /**
     * <a href="http://math.nist.gov/javanumerics/jama/">Jama</a> [math.nist.gov] style: construct a 2D real matrix from
     ...
     * 
     * @param vector
     *            - column-packed vector of elements
     */
     ...
     * 
     * @param buffa
     *            the source buffer to be compared
     * @param buffb
     *            the destination buffer to be compared
