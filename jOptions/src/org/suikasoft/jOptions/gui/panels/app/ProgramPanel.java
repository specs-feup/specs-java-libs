...
/**
 * Panel used to indicate the setup file and which can start and cancel the
 * execution of the program. Also shows the output of the program.
 *
 * <p>
 * This panel provides controls for selecting setup files, starting/cancelling
 * execution, and displaying output.
 *
...
public class ProgramPanel extends GuiTab {
     ...
     *
     * @param lastFilesString the string containing file paths separated by the
     *                        separator
    ...
    /**
     * Called when entering the tab. Updates the filename text field with the
    ...
    /**
     * Called when exiting the tab. Updates the configuration file and current
     * folder path in the DataStore.
     */
    @Override
    public void exitTab() {
