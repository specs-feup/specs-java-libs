 ...
 * an enum class implementing SetupField with the options it wants to use,
...
public interface App {
    ...
    *
    * Method throws InterruptedException to support canceling the task. In the
   ...
   /**
    * @return a Collection containing the EnumKeys which will build the setup of
    * this application.
    */
