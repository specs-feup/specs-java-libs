...
import pt.up.fe.specs.guihelper.gui.BasePanels.ProgramPanel;
...
public class ApplicationWorker {
     ...
     * @param options
     */
    public void execute(final File options) {
     ...
     * @param options
     */
    private void runner(File options) {
	// Disable buttons
	setButtons(false);
     ...
     * @return
     */
    private Callable<Integer> getTask(final File options) {
