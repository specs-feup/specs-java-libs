...
public class NotImplementedException extends UnsupportedOperationException {
    ...
    public NotImplementedException(Enum<?> anEnum) {
        super(getDefaultMessage(anEnum));
    }

    public NotImplementedException(Class<?> origin) {
        super(getDefaultMessage(origin.getName()));
    }
    ...
    private static String getDefaultMessage(String originClass) {
        return "Not yet implemented in class '" + originClass + "'";
    }

    private static String getDefaultMessage(Enum<?> anEnum) {
