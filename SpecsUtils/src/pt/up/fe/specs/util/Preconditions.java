 ...
 * methods generally accept a {@code boolean} expression which is expected to
 * be {@code true} (or in the case of {@code checkNotNull}, an object reference
 ...
 * <b>not recommended</b> because it is misleading to future readers of the
 * code and of stack traces. See <a href=
 ...
 * {@code "%s"} specifier is supported, not the full
 * range of {@link java.util.Formatter} specifiers. However, note that if the
 * number of arguments does not match the number of occurrences of {@code "%s"}
 * in the format string, {@code Preconditions} will still behave as expected,
 * and will still include all argument values in the error message; the message
...
public final class Preconditions {
    ...
    /**
     * Ensures that {@code index} specifies a valid <i>element</i> in an array, list
     * or string of size {@code size}. An
