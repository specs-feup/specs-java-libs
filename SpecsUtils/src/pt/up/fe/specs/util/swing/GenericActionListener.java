/*
 * GenericActionListener.java
 *
 * Utility class for handling action events in Java Swing applications. Provides a generic implementation of ActionListener for use in the SPeCS ecosystem.
 *
