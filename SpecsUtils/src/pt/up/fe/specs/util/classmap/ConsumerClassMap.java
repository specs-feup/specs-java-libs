...
/**
 * Maps a class to a Consumer that receives an instance of that class being used as key and other object.
 *
 * @param <T>
 * @author JoaoBispo
 */
public class ConsumerClassMap<T> {
    ...
    /**
     * Calls the Consumer.accept associated with class of the value t, or throws an Exception if no Consumer could
     * be found in the map.
     *
     * @param t
     */
