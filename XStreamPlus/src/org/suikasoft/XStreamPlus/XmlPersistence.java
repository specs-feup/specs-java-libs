...
/**
 * Implementation of {@link PersistenceFormat} for XML serialization using XStream.
...
public class XmlPersistence extends PersistenceFormat {
   ...
   private final Map<Class<?>, ObjectXml<?>> xmlObjects = SpecsFactory.newHashMap();
     ...
     * If a mapping for a class already exists, it will be replaced and a warning will be logged.
     *
